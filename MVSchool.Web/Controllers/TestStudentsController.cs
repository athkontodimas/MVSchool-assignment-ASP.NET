...
namespace MVSchool.Web.Controllers
{
    public class TestStudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentId,FirstName,LastName,DateOfBirth,PhotoUrl")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentId,FirstName,LastName,DateOfBirth,PhotoUrl")] Student student)
        {
            if (ModelState.IsValid)
            {
