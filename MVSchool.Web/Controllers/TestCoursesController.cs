...
namespace MVSchool.Web.Controllers
{
    public class TestCoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseId,Title,StartDate,EndDate")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseId,Title,StartDate,EndDate")] Course course)
        {
            if (ModelState.IsValid)
            {
