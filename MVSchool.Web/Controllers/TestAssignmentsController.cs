...
namespace MVSchool.Web.Controllers
{
    public class TestAssignmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AssignmentId,Title,SubmissionDate,Description")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AssignmentId,Title,SubmissionDate,Description")] Assignment assignment)
        {
            if (ModelState.IsValid)
            {
